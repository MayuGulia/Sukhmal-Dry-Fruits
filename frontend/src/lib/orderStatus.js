...
export function statusSlug(raw) {
...
export function isShippedStatus(raw) {
  return canonicalStatus(raw) === 'Shipped';
}

export function showTrackingFields(raw) {
  return statusIndex(raw) >= ORDER_STATUSES.indexOf('Shipped');
}

export function courierTrackingUrl(courierName, trackingNumber) {
